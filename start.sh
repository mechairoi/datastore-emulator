...
# Run the datastore
/cloud-datastore-emulator/cloud_datastore_emulator start --host=0.0.0.0 --port=8282 --store_on_disk=false --consistency=1.0 --firestore_in_datastore_mode /datastore
